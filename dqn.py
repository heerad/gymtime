...
epsilon_step = (epsilon_start-epsilon_end)/epsilon_decay_length
...
for ep in range(num_episodes):
	...
	for t in range(max_steps_ep):
		...
		epsilon = epsilon_start-epsilon_step*min(total_steps,epsilon_decay_length)

		if total_steps == epsilon_decay_length:
			print('--------------------------------STOPPED DECAYING EPSILON---------------------------------------------')
